            ...
            createOpAdmin: function() {
                ...
                .catch(error => {
                    ...
                    if(error.response.data.errors.name){
                        this.failMessage = error.response.data.errors.name[0];
                        ...
                        this.failMessage = error.response.data.errors.password[0];
                        this.showFailure = true;
                    }
                    else if(error.response.data.errors.type){
                        this.failMessage = error.response.data.errors.type[0];
                        this.showFailure = true;
                    }else if (error.response.data.errors.photo){
                        this.failMessage = error.response.data.errors.photo[0];
                        this.showFailure = true;
                    }
                });
            },
